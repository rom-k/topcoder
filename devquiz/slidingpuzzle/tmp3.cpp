...
int main() {
    ...
    open.insert(pair<string, int>("‚ ", 3));
    open.insert(pair<string, int>("‚¢", 2));
    open.insert(pair<string, int>("‚¤", 1));
    open.insert(pair<string, int>("‚¦", 10));
    open.insert(pair<string, int>("‚¨", 8));
    
    open.insert(pair<string, int>("‚©", 6));
    open.insert(pair<string, int>("‚«", 6));
    open.insert(pair<string, int>("‚­", 6));
    open.insert(pair<string, int>("‚¯", 6));
    open.insert(pair<string, int>("‚±", 6));
